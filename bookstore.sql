...
CREATE TABLE `cart_itmes`  (
  ...
  `cart_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `order_items`  (
  ...
  `img_path` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
